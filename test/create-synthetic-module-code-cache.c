...
main() {
  ...
  // A synthetic module has no source and so cannot be serialized to a code
  // cache. The attempt fails and leaves a pending exception.

  void *data;
  size_t len;
  e = js_create_module_code_cache(env, synthetic, &data, &len);
