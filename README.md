...
By default, the library is compiled with static V8 prebuilds generated by <https://github.com/holepunchto/v8-prebuilds>. You can bring along your own build of V8 by defining the `V8` and `V8_INCLUDE_DIR` variables when generating a CMake build. If you rely on the default V8 prebuilds, make sure to first checkout <https://github.com/holepunchto/v8-prebuilds> and follow the instructions on how to make a prebuild.
